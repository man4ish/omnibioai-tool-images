...
RUN printf 'server {\n\
    ...
    index index.html;\n\
    location /_svc/toolimages/ { alias /usr/share/nginx/html/; try_files $uri $uri/ /_svc/toolimages/index.html; }\n\
